#############################################################################
# Makefile for building: CyclicDependencies
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  CyclicDependencies.pro
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile CyclicDependencies.pro
#############################################################################
...
INCPATH       = -I. -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = CyclicDependencies1.0.0
DISTDIR = /home/yioannidis/CyclicDependencies/.tmp/CyclicDependencies1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
OBJECTS       = main.o \
		...
		agent.o
DIST          = ../.qmake.stash \
		CyclicDependencies.pro flock.h \
		agent.h main.cpp \
		flock.cpp \
		agent.cpp
QMAKE_TARGET  = CyclicDependencies
DESTDIR       = 
TARGET        = CyclicDependencies
...
Makefile: CyclicDependencies.pro ../.qmake.cache /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		CyclicDependencies.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile CyclicDependencies.pro
